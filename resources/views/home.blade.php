...
<section class="panel">
        ...
        <input type="number" name="group_id" placeholder="Group Id" class="form-control" required="required">
        ...
        <label>Skype</label>
        <input type="text" name="skype_id" placeholder="Skype Address" class="form-control" required="required">
        ...
        <select class="form-control js-example-basic-single" name="country" required="required">
            ...
            <option value="{{$record->country_name}}">{{$record->country_name}}</option>
            @endforeach
        </select>
        ...
        <textarea rows="6" name="details" class="form-control" required="required"></textarea>
